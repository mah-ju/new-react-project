...
export const Highlights = () => {
    ...
    return (
        <div>
            <h1 className="text-4xl mt-3 py-3 text-center text-transparent font-bold bg-clip-text
             bg-gradient-to-r from-indigo-300 via-purple-400 to-pink-600">Urban Highlights</h1>
            ...
            <div className="flex justify-center items-center space-x-3 mt-4">
                ...
                <img src={images[currentImg].path} alt={images[currentImg].alt} 
