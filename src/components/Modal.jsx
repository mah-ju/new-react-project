  ...
  return (
    <div className="bg-black/70 h-full w-full fixed flex flex-col justify-center">
      <div className="bg-white pb-5 mx-5 rounded-lg">
        ...
        <h3
          className="text-3xl font-bold mt-1 px-3 text-center 
        ...
        <p className="px-4 text-center text-lg pt-3">
          Hi, <span className="font-bold text-purple-base">{name}</span>!{" "}
          <br></br> Welcome to our community!
        </p>

        <p className="text-center px-4 pt-4">
          Your email,{" "}
          <span className="font-bold text-purple-base">{email}</span> was
          subscribed successfully.
        </p>

        <p
          className="text-pink-500 font-bold mt-5 text-xl 
text-center"
        >
          See you soon!
        </p>
