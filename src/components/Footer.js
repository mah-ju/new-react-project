...
<div className ="bg-pink-300/60 
flex  items-center justify-around pr-3 py-8">

<div className="flex flex-col">
<p className="font-bold text-purple-base pb-2">Some Links</p>
<ul className="text-sm">
<li><a href="#" className="underline">Travel Safer</a></li>
<li><a href="#" className="underline">Free Infos</a></li>
<li><a href="#" className="underline">Organizer.com</a></li>
</ul>
