   ...
   const isCurrentPage = (path) =>{
    ...
    return(
        ...
        className="w-2/5 bg-pink-300/60 pb-2 absolute md:hidden">
           ...
           <li>
           <Link href="/" className={`${isCurrentPage("/")}`}>Home</Link>
           </li>
           <li>
           <Link href="/about" className={`${isCurrentPage("/about")}`}>About</Link>
           </li>
           <li>
           <Link href="/projects" className={`${isCurrentPage("/projects")}`}>Projects</Link>
           </li>
           <li>
           <Link href="/partners" className={`${isCurrentPage("/partners")}`}>Partners</Link>
            </li>
           <li>
          <Link href="/contact" className={`${isCurrentPage("/contact")}`}>Contact</Link>
          </li>
            </ul>
